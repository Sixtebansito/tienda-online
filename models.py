...
class Usuario(db.Model):
    ...
    def set_password(self, password_plano):
        self.password_hash = generate_password_hash(password_plano, method='pbkdf2:sha256')
